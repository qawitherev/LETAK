 ...
 * Use the [ParkingConfirmationFragment.newInstance] factory method to
...
class ParkingConfirmationFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ParkingConfirmationFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ParkingConfirmationFragment().apply {
